package br.com.projeto.erudio.seguranca.jwt;


import br.com.projeto.erudio.exceptions.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public TokenVO createAcessToken(String userName, List<String> roles) {
        ...
        return new TokenVO(userName, Boolean.TRUE, now, validity, acessToken, refreshToken);
    }
